...
var allLayerTypesUI = function () {
    ...
    if (comp instanceof CompItem) {
        compLayers = (0, utils_1.allLayersByType)(comp, TextLayer);
    }
    var index = -1;
    var nextPrevious = function (dir) {
        var max = compLayers.length;
        if (max === 0) {
            var comp_1 = app.project.activeItem;
            if (comp_1 instanceof CompItem) {
                compLayers = (0, utils_1.allLayersByType)(comp_1, TextLayer);
            }
            else {
                return;
            }
