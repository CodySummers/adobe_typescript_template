...
exports.allLayerTypesUI = void 0;
var utils_1 = __webpack_require__(721);
var allLayerTypesUI = function () {
    var compLayers;
    var index = -1;
    var nextPrevious = function (dir) {
        var max = compLayers.length;
        if (max === 0) {
            var comp = app.project.activeItem;
            if (comp instanceof CompItem) {
                compLayers = (0, utils_1.allLayersByType)(comp, types[type.selection.index]);
            }
            else {
                return;
            }
        ...
        for (; index < max && index >= 0; index += dir) {
            try {
                var viewer = compLayers[index].comp.openInViewer();
                if (!viewer)
                    throw 'Cannot find Comp';
                var command = app.findMenuCommandId('Deselect All');
    ...
    typeGroup.margins = 0;
    var types = [AVLayer, CameraLayer, LightLayer, ShapeLayer, TextLayer];
    var types_array = ["AV Layer", "Camera Layer", "Light Layer", "Shape Layer", "Text Layer"];
    ...
    right.text = ">";
    var layersFound = palette.add("statictext", undefined, undefined, { name: "layersFound" });
    layersFound.text = '';
    layersFound.minimumSize.width = 230;
    layersFound.justify = 'center';
    right.onClick = function () { nextPrevious(1); };
    left.onClick = function () { nextPrevious(-1); };
    var refreshLayers = function () {
        ...
        if (comp instanceof CompItem) {
            compLayers = [];
            compLayers = (0, utils_1.allLayersByType)(comp, types[type.selection.index]);
            var length_1 = compLayers.length;
            layersFound.text = "".concat(length_1, " ").concat(length_1 === 1 ? 'Layer' : 'Layers', " Found");
        }
    };
    refreshLayers();
...
exports.allLayerTypesUI = allLayerTypesUI;
...
exports.__esModule = true;
exports.allLayersByType = void 0;
var allLayersByType = function (comp, type, list) {
    if (list === void 0) { list = []; }
    for (var i = 1; i <= comp.numLayers; i++) {
        var layer = comp.layers[i];
        if (layer instanceof type) {
            list.push({ comp: comp, layer: layer });
        }
        if (layer.source && layer.source instanceof CompItem) {
            list.concat((0, exports.allLayersByType)(layer.source, type, list));
        }
    }
    return list;
};
exports.allLayersByType = allLayersByType;
